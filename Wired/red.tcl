####
#   TCP : RED and DropTail Comparison
#   
#   @authors: vsubhashini
###
...
#Queue/RED set thresh_ 70
#Queue/RED set maxthersh_ 95
...
#	exec nam out.nam &
#	exec grep  "a" redq.tr > ave.tr
#	exec grep  "Q" redq.tr > cur.tr
	exit 0
}
...
#	for {set j 1} {$j<=$numSrc} {incr j} {
#		set totsntsrc($j) [$tcpsrc($j) set ndatabytes_]
#		set totretsrc($j) [$tcpsrc($j) set nrexmitbytes_]
#		set throughput($j) [expr [expr $tcpsntsrc($j) - $totretsrc($j)] / 4.3]
